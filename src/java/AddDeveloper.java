   ...
   String msg;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
          ...
          PreparedStatement ps=con.prepareStatement("select email from adddeveloper where name=?");
          
          ps.setString(1, name);
          ResultSet rs=ps.executeQuery();
          if(!rs.next()){
              PreparedStatement pst=con.prepareStatement("insert into adddeveloper (name, email) values(?,?)");
          pst.setString(1, name);
          pst.setString(2, email);
          int res=pst.executeUpdate();
          if(res>0){
              disp=request.getRequestDispatcher("DeveloperAccount.jsp");
	...
	Authenticator auth = new Authenticator() {
		...
		Transport.send(msg);
              ...
              disp=request.getRequestDispatcher("Adddeveloper.jsp");
